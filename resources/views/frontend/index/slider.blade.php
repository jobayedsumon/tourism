...
<section class="flexslider-container" id="flexslider-container-1">
    ...
    <div class="flexslider slider" id="slider-1">
        <ul class="slides">
            ...
            <li class="item-1" style="background:			linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url({{asset('frontend/images/hotel_theme.jpg')}}) 50% 0%;
	background-size:cover;
	height:100%;">
                <div class=" meta">
                    <div class="container">
                        <h2>Tour BD Finding Your Hotel Now</h2>
                        <h1>Just One Click</h1>
                        <a href="{{ URL::to('show-hotel') }}" class="btn btn-default">View More</a>

                    </div><!-- end container -->
                </div><!-- end meta -->
            </li><!-- end item-1 -->

            <li class="item-2" style="background:			linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url({{asset('frontend/images/homepage-slider-1.jpg')}}) 50% 0%;
	background-size:cover;
	height:100%;">
                <div class=" meta">
                    <div class="container">
                        <h2>Discover Tourist Area Hotel</h2>
                        <h1 class="text-capitalize">Hotel From Hotel Finder</h1>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="nav nav-tabs center-tabs">
                        <li><a href="#hotels" data-toggle="tab"><span><i class="fa fa-building"></i></span><span class="st-text">Tour BD Hotel Area and Transport Service</span></a></li>
                    </ul>
                                        ...
                                        <div class="row">
                                            <form class="navbar-form navbar-left" action="{{ URL::to('find') }}" method="POST">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="search" name="search" class="form-control" placeholder="Please Search here">
