    ...
    <section class="flexslider-container" id="flexslider-container-1">
        ...
        <div class="flexslider slider" id="slider-1">
            <ul class="slides">
                ...
                <li class="item-1" style="background:			linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url({{asset('frontend/images/tourist_theme.jpg')}}) 50% 0%;
                        background-size:cover;
                        height:100%;">
                    <div class=" meta">
                        <div class="container">
                            <h1>Discover Tourist Area</h1>
                            <a href="{{ URL::to('show-tourist') }}" class="btn btn-default">View More</a>
                                ...
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-10 col-lg-offset-1">
                                            <div class="row">
                                                <form class="navbar-form navbar-left" action="{{ URL::to('find-tourist') }}" method="POST">
                                                    {{ csrf_field() }}
                                                    <div class="input-group">
                                                        <input type="text" id="search2" name="search" class="form-control" placeholder="Search Tourist area Location">
